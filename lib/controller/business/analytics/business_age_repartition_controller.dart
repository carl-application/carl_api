...
class BusinessAgeRepartitionController extends ResourceController {
  ...
  @Operation.post()
  Future<Response> getAgeRepartition(@Bind.body() BusinessAnalyticsParams params) async {
    ...
    final first = _getQueryFor(0, 18, account.business.id, params);
    ...
    final second = _getQueryFor(18, 25, account.business.id, params);
    ...
    final third = _getQueryFor(25, 30, account.business.id, params);
    ...
    final fourth = _getQueryFor(30, 40, account.business.id, params);
    ...
    final fifth = _getQueryFor(40, 50, account.business.id, params);
    ...
    final sixth = _getQueryFor(50, 60, account.business.id, params);
    ...
    final seventh = _getQueryFor(60, 100, account.business.id, params);
  ...
  String _getQueryFor(int ageMin, int ageMax, int businessId, BusinessAnalyticsParams params) {
    return """
