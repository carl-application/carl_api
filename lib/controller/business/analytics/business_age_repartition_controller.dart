...
class BusinessAgeRepartitionController extends ResourceController {
  ...
  Future<Response> getAgeRepartition() async {
    ...
    final second = _getQueryFor(19, 25, account.business.id);
    ...
    final third = _getQueryFor(26, 30, account.business.id);
    ...
    final fourth = _getQueryFor(31, 40, account.business.id);
    ...
    final fifth = _getQueryFor(41, 50, account.business.id);
    ...
    final sixth = _getQueryFor(51, 60, account.business.id);
